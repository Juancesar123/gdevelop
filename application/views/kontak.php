                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="about">About</a></li>
						 <li class="active"><a href="kontak">contact us</a></li>
                    </ul>
                </div>
            </div>
        </div>
			...
			<div class="col-xs-12">
				<div class="row">
					<div class="col-md-5">
						<div class="box">
							<div class="box-gray aligncenter">
								...
								<p>
								Harga Cukup murah untuk reguler adalah Rp 30.000,00/sesi dan untuk Private Rp 40.000,00
								</p>
					...
					<div class="col-md-5">
						<div class="box">
							<div class="box-gray aligncenter">
								<h4>Info Hari Masuk</h4>
								<div class="icon">
								<i class="fa  fa-home fa-3x"></i>
								</div>
								<p>
								Masuk Setiap Hari Senin,Rabu,Jumaat untuk reguler dari pagi sampai sore untuk private hari sabtu malam pkl 19.00-20.00 WIB
								</p>
