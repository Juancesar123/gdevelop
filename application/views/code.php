  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Masukkan code</h4>
      </div>
...
<div id="myModal3" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Copas code</h4>
      </div>
      <div class="modal-body">
	  <label>Judul code</label>
        <div class="form-group">
	  ...
	  <label>Pilihan</label>
        <div class="form-group">
		<select class = "form-control" ng-model="pilihan" disabled>
		<option value="1">JQUERY</option>
		<option value="2">PHP Framework</option>
		<option value="3">HTML dan CSS</option>
		<option value="4">PHP Native</option>
	   ...
	   <label>isi file</label>
	  <div class="form-group">
	  <textarea class="form-control" rows=8 ng-model="kode"></textarea>
	  </div>
	  </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<table datatable="ng" ng-init="getdata()"dt-columns="dtColumns"dt-options="dtOptions"class="table table-bordered table-striped">
<thead>
<th>judul</th>
<th>materi</th>
<th>code</th>
...
if (!$this->ion_auth->is_admin())
{
echo "<td><button class='btn btn-primary' data-toggle=\"modal\" data-target=\"#myModal3\" ng-click='download(item,item.code,item.filename)'><i class=\"fa fa-eye\"></i></button></td>";		
	}else{
		echo"<td><button class=\"btn btn-success\" ng-click=\"edit(item,judul,code)\" data-toggle=\"modal\" data-target=\"#myModal2\"id=\"edit\"><i class=\"fa fa-edit\"></i></button>
<button class=\"btn btn-danger\" ng-click=\"hapus(item.id,item.code)\"><i class=\"fa fa-trash\"></i></button></td>";
	}
?>
</tr>
</tbody>
